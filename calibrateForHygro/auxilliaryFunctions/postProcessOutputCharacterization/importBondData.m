function DEXP = importBondData(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   DEXP = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   DEXP = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   DEXP = importfile('DEXP.csv', 1, 78961);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/22 11:00:02
