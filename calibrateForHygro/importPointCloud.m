function file1L10 = importPointCloud(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   FILE1L10 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the default
%   selection.
%
%   FILE1L10 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows STARTROW
%   through ENDROW of text file FILENAME.
%
% Example:
%   file1L10 = importfile('file1_L10.0_W10.0_g55.0.xyz', 1, 165025);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/05/22 15:11:23
...
formatSpec = '%10f%15f%15f%15f%15f%15f%f%[^\n\r]';
