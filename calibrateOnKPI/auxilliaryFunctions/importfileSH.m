function sbatchFile = importfileSH(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SBATCHFILE = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   SBATCHFILE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   sbatchFile = importfile('sbatchFile.sh', 1, 5);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/04/30 10:35:26
