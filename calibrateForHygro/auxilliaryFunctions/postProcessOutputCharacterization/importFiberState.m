function eState = importFiberState(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ESTATE = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   ESTATE = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   eState = importfile('eState.csv', 1, 51591);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/11/05 09:39:28
...
formatSpec = '%12f%12f%12f%12f%12f%12f%12f%12f%12f%f%[^\n\r]';
